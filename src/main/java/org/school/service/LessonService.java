...
public class LessonService {
    ...
    public PaginationResponseDTO<LessonResponseDTO> getAllLessons(Integer page, Integer size, Long classeId) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("createdAt").descending());
        Page<LessonResponseDTO> result = lessonRepository.findByClasse_id(classeId, pageable).map(LessonMapper::toDTO);
